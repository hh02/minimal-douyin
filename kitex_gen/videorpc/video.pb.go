...
var file_video_proto_depIdxs = []int32{
	...
	2, // 2: video.QueryVideoByUserIdResponse.videos:type_name -> video.Video
	0, // 3: video.QueryVideoByUserIdResponse.base_resp:type_name -> video.BaseResp
	3, // 4: video.VideoService.CreateVideo:input_type -> video.CreateVideoRequest
	5, // 5: video.VideoService.QueryVideoByUserId:input_type -> video.QueryVideoByUserIdRequest
	4, // 6: video.VideoService.CreateVideo:output_type -> video.CreateVideoResponse
	6, // 7: video.VideoService.QueryVideoByUserId:output_type -> video.QueryVideoByUserIdResponse
