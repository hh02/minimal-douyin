...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	handlerType := (*likerpc.UserService)(nil)
...
func createLikeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(likerpc.UserService).CreateLike(ctx, req)
		if err != nil {
			return err
		}
	...
	case *CreateLikeArgs:
		success, err := handler.(likerpc.UserService).CreateLike(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getUserHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(likerpc.UserService).GetUser(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetUserArgs:
		success, err := handler.(likerpc.UserService).GetUser(ctx, s.Req)
		if err != nil {
			return err
		}
...
func mGetUserHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(likerpc.UserService).MGetUser(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *MGetUserArgs:
		success, err := handler.(likerpc.UserService).MGetUser(ctx, s.Req)
		if err != nil {
			return err
		}
