...
func (p *kUserServiceClient) CreateLike(ctx context.Context, Req *likerpc.CreateLikeRequest, callOptions ...callopt.Option) (r *likerpc.CreateLikeResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateLike(ctx, Req)
}

func (p *kUserServiceClient) GetUser(ctx context.Context, Req *likerpc.DeleteLikeRequest, callOptions ...callopt.Option) (r *likerpc.DeleteLikeResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetUser(ctx, Req)
}

func (p *kUserServiceClient) MGetUser(ctx context.Context, Req *likerpc.QueryLikeByUserIdRequest, callOptions ...callopt.Option) (r *likerpc.QueryLikeByUserIdResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
