...
import (
	context "context"
	commentrpc "github.com/hh02/minimal-douyin/kitex_gen/commentrpc"
...
type FeedResponse struct {
	...
	VideoList  []*videorpc.Video `protobuf:"bytes,4,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty"`
}
...
func (x *RelationFollowerListResponse) GetUserList() []*userrpc.User {
	if x != nil {
		return x.UserList
	}
	return nil
...
var file_response_proto_rawDesc = []byte{
	...
	0x65, 0x6f, 0x52, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x85, 0x01,
	...
	0x73, 0x65, 0x72, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x87, 0x01,
	...
	0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x68, 0x30, 0x32, 0x2f, 0x6d, 0x69, 0x6e, 0x69, 0x6d,
	0x61, 0x6c, 0x2d, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78, 0x5f,
	0x67, 0x65, 0x6e, 0x2f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_response_proto_goTypes = []interface{}{
	...
	(*RelationFollowerListResponse)(nil), // 12: response.RelationFollowerListResponse
...
var file_response_proto_depIdxs = []int32{
	...
	14, // 7: response.RelationFollowerListResponse.user_list:type_name -> user.User
